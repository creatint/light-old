...
class _SliderState extends State<CustomSlider> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return new _SliderRenderObjectWidget(
      ...
      onEnded: (widget.onEnded != null) && (widget.max > widget.min) ? _handleEnd : null,
      state: this,
    );
  }
}
...
class _RenderSlider extends RenderBox {
  ...
  ValueChanged<double> get onEnded => _onEnded;
  ValueChanged<double> _onEnded;
  set onEnded(ValueChanged<double> value) {
    if (value == _onEnded) {
      return;
    }
    _onEnded = value;
